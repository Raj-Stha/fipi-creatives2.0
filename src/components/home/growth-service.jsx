...
export default function GrowthServices() {
  ...
  return (
    <section ref={containerRef} className="sticky  bg-black  text-white">
      {/* Sticky Background Section */}
      <div className="sticky top-0 w-full h-[400px] flex flex-col items-center justify-center overflow-hidden z-0">
        ...
        >
          <motion.h2
            ...
            className="text-6xl md:text-8xl lg:text-[8rem]  font-bold tracking-tighter   leading-none pb-4 pr-4"
          >
          ...
          <motion.p
            ...
            className="text-xl  font-light leading-relaxed mx-auto max-w-3xl"
          >
            Strategic growth solutions designed to elevate brands and accelerate
        ...
        {services.map((service, i) => (
          ...
          >
            ...
            <div className={`relative w-full lg:w-[65%] xl:w-[60%]  group`}>
              {/* Outer Glow */}
              <div
                className={`absolute -inset-4 bg-gradient-to-br ${service.color} blur-2xl opacity-40 transition-opacity duration-700 group-hover:opacity-70`}
              ></div>

              {/* Decreased aspect ratio for a smaller, sleeker container */}
              <div className="relative w-full aspect-[4/3] md:aspect-[16/9] rounded-lg overflow-hidden bg-neutral-900 shadow-2xl flex items-end p-4 md:p-6 lg:p-8">
                {/* Image Background */}
                ...
                <div className="relative z-20 w-full md:w-[90%] lg:w-[85%] p-6 md:p-8 rounded-[0.5rem] bg-black/10 border border-white/[0.15] backdrop-blur-xl shadow-2xl transition-all duration-500 overflow-hidden">
                  ...
                  <div
                    className={`absolute -top-32 -right-32 w-64 h-64 bg-gradient-to-br ${service.color} opacity-20 rounded-full blur-[60px] pointer-events-none transition-opacity duration-700`}
                  ></div>
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    <div className="flex flex-wrap items-center gap-4 mb-4 md:mb-6">
                      ...
                      <div className="flex items-center gap-3 bg-fuchsia-800 backdrop-blur-md border border-white/20 py-2 px-5 rounded-full shadow-lg">
                        <span
                          className={`w-2 h-2 rounded-full bg-green-600 shadow-[0_0_12px_rgba(255,255,255,0.6)]`}
                        ></span>
