  ...
  return (
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden bg-gray-100 flex-shrink-0">
        ...
        <div
          className="absolute bottom-3 left-3 w-11 h-11 rounded-2xl flex items-center justify-center shadow-lg border-2 border-white z-10 transition-transform duration-300 group-hover:scale-110"
